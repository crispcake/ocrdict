...
public class ImageRoundedDrawable extends Drawable {
    ...
    ImageRoundedDrawable(Bitmap bitmap, float cornerRadius, int border, ColorStateList borderColor) {
        this(bitmap, cornerRadius, border, borderColor, false);
    }

    ImageRoundedDrawable(Bitmap bitmap, float cornerRadius, int border, ColorStateList borderColor, boolean oval) {
    ...
    public static Drawable fromDrawable(Drawable drawable, float radius, int border, ColorStateList borderColor, boolean isOval) {
        if (drawable != null) {
            if (drawable instanceof TransitionDrawable) {
                ...
                for (int i = 0; i < num; i++) {
                    ...
                    if (d instanceof ColorDrawable) {
                        ...
                        drawableList[i] = new ImageRoundedDrawable(drawableToBitmap(td.getDrawable(i)), radius, border, borderColor, isOval);
                    }
                }
            ...
            if (bm != null) {
                return new ImageRoundedDrawable(bm, radius, border, borderColor, isOval);
            } else {
